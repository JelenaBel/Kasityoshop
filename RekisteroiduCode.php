...
if ($mysqli -> connect_errno) {
  ...
  exit();
    ...
    $query = "INSERT INTO customers (id_asiakkaat, etunimi_asiakkaat, sukunimi_asiakkaat, email_asiakkaat, 
    salasana_asiakkaat, puhelinNumero_asiakkaat, katuosoitte_asiakkaat,	postinumero_asiakkaat,	postitoimituspaikka_asiakkaat) 
...
try {
    ...
    //Recipients
    $mail->setFrom('obyelousova@gmail.com', 'HandyShop!');
    ...
    $mail->Subject = 'HandyShop! Rekisterointi onnustunut!';
    $mail->Body    = 'Terve, '.$fname.'<br>  Sinun rekisterointi HandyShop web-sivustossa on onnistunut. Käyttää loginiksi sinun e-mail, joka te käytätte rekisteroitymisessa.';
